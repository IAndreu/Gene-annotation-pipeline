...
run_bitacora="/path/to/bitacora-master/runBITACORA_command_line.sh" # Make sure to edit the script from bitacora and add the path of bitacora scripts and gemoma in there.
num_threads=4
############################
